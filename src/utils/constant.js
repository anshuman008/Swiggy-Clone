...
export const SWIGGY_RESTAURANT_API_END_POINT = `https://proxy.cors.sh/https://www.swiggy.com/dapi/restaurants/list/v5?is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING`
export const SWIGGY_RESTAURANT_DETAIL_API_END_POINT = `https://proxy.cors.sh/https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=12.9715987&lng=77.5945627&restaurantId=`
export const LOCATION_SUGGESTION_API_END_POINT = `https://proxy.cors.sh/https://www.swiggy.com/dapi/misc/place-autocomplete?input=`
export const ADDRESS_RECOMMEND_API_END_POINT = `https://proxy.cors.sh/https://www.swiggy.com/dapi/misc/address-recommend?place_id=`
